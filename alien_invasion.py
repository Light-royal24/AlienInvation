...
from games_stats import GamesStats
from button import Button
from scoreboard import Scoreboard

class AlienInvasion:
    """Overall class to manage game assets and behaivior."""
    ...
    def run_game(self):
        ...
        while True:
            ...
            if self.stats.game_active:
                # update the ship position by calling the ship update
                self.ship.update()
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # if so, get rid of the the bullet and the alien.
